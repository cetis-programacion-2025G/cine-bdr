...
function datosCine() {
    $peliculas = [
        ['id' => 1, 'titulo' => 'Kung Fu Panda 4',          'genero' => 'Animación', 'duracion' => 94],
        ['id' => 2, 'titulo' => 'Sonic 3',                   'genero' => 'Aventura',  'duracion' => 109],
        ['id' => 3, 'titulo' => 'La Era de Hielo',           'genero' => 'Animación', 'duracion' => 81],
        ['id' => 4, 'titulo' => 'Spider-Man: No Way Home',   'genero' => 'Acción',    'duracion' => 148],
        ['id' => 5, 'titulo' => 'El Señor de los Anillos',   'genero' => 'Fantasía',  'duracion' => 178],
    ];
